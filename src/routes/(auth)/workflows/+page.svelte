			...
			{#each workflows.data as workflow}
				<div class="flex flex-col p-xs">
					<div class="flex items-center gap-x-xs">
						<a href={`/workflows/${workflow.id}`} class="text-2xl italic">{workflow.name}</a>
					</div>
